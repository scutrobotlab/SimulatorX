...
namespace Honeti
{
    public class I18NTMPText : MonoBehaviour
    {
        ...
        private void _init()
        {
            ...
            _defaultFontSize = (int)_text.fontSize;
            _defaultAlignment = (TextAnchor)_text.alignment;
            _key = _text.text;
            _initialized = true;
        ...
        private void _changeFont(I18NFonts f)
        {
            ...
            if (f != null)
            {
                ...
                {
                    _text.alignment = (TextAlignmentOptions)_getAnchorFromAlignment(f.alignment);
                }
            }
            else
            {
                ...
                _text.alignment = (TextAlignmentOptions)_defaultAlignment;
            }
        }
